...
import com.example.luckybookpreview.ui.renderers.CurlRenderer;
import com.example.luckybookpreview.utils.CurlMesh;

import static android.content.ContentValues.TAG;

public class CurlView extends GLSurfaceView implements View.OnTouchListener, CurlRenderer.Observer {

    private static final int WRAP_CONTENT_MARGIN = 1;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int margin =200;
        setMeasuredDimension(height + height * 2-margin, height + height / 2-margin/2);
    }
    ...
    public void onSizeChanged(int w, int h, int ow, int oh) {
        ...
        if (mSizeChangedObserver != null) {
            mSizeChangedObserver.onSizeChanged(this, w, h);
        }
    }
        ...
        switch (me.getAction()) {
            ...
            case MotionEvent.ACTION_UP: {
                if (mCurlState == CURL_LEFT || mCurlState == CURL_RIGHT) {
                    ...
                    if (!(mCurrentIndex == 0 || (mCurrentIndex == 1 && mCurlState == CURL_LEFT) || mCurrentIndex == mPageProvider.getPageCount() || (mCurrentIndex == mPageProvider.getPageCount() - 1 && mCurlState == CURL_RIGHT))) {
                        {
    ...
    public void setMargins(int tag) {
        if (tag == WRAP_CONTENT_MARGIN) {
    ...
    private void updateCurlPos(PointerPosition pointerPos) {
        Log.d(TAG, "updateCurlPos: " + pointerPos.mPos.x + "x" + pointerPos.mPos.y);
        // Default curl radius.
    ...
    public interface SizeChangedObserver {
         ...
         */
        public void onSizeChanged(CurlView curlView, int width, int height);
    }
