...
public class MultiImageSelectorFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mTemplate = (PageTemplate) getArguments().get(EXTRA_PAGE_TEMPLATE);
        mImageAdapter = new ImageGridAdapter(getActivity(),mTemplate, showCamera(), 3);
        ...
        mGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (SizeUtils.imageSizeValid(image,mTemplate)) {
    ...
    private int selectImageCount() {
        return getArguments() == null ? 20 : getArguments().getInt(EXTRA_MAX_SELECT_COUNT, 20);
    }
