...
//        return getController().getPosition();
//    }

//    public void setPosition(int position) {
//        getController().setPosition(position);
//    }

    public void setPicture(Picture picture){
        getController().setPicture(picture);
    }
    ...
    public void centerCrop(){
        ...
        /*hack, so we update preview 0.5 sec after*/
        /*postDelayed(new Runnable() {
            @Override
            public void run() {
                getController().setStateUpdated();
            }
        },500);*/
        getController().setStateUpdated();
    }
