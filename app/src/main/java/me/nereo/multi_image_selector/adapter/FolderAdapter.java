...
public class FolderAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (holder != null) {
            /*if(i == 0){
                ...
                holder.size.setText(mContext.getResources().getString(R.string.mis_photo_unit,
                        getTotalImageSize()));
                if(mFolders.size()>0){
    ...
    class ViewHolder{
        ...
        void bindData(Folder data) {
            ...
            if (data.images != null) {
                size.setText(mContext.getResources().getString(R.string.mis_photo_unit, data.images.size()));
            }else{
                size.setText(mContext.getResources().getString(R.string.mis_photo_unit,0));
            }
            if (data.cover != null) {
                // 显示图片
                Picasso.with(mContext)
