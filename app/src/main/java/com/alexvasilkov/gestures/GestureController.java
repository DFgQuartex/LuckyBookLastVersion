...
//    }
    ...
    public void setStateUpdated() {
        if (mOnChangedListener != null) {
            mOnChangedListener.onChanged(mPicture, getState(),getSettings());
        }
    }
    ...
    public boolean onTouch(@NonNull View view, @NonNull MotionEvent event) {
        if(getSettings()!=null&&!getSettings().isGesturesEnabled()){
            return false;
        }
    ...
    public interface OnChangedListener {
        void onChanged(Picture place, State state,Settings settings);
    }
