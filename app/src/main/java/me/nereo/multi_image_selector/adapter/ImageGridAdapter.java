...
public class ImageGridAdapter extends BaseAdapter {
    ...
    public ImageGridAdapter(Context context, PageTemplate pageTemplate, boolean showCamera, int column){
        mContext = context;
    ...
    class ViewHolder {
        ...
        ViewHolder(View view){
            ...
            selectIndex= (TextView) view.findViewById(R.id.select_index);
            invalidSize=view.findViewById(R.id.size_type);
            view.setTag(this);
        }
        ...
        void bindData(final Image data){
            ...
            if(showSelectIndicator){
                int selectedPosition=mSelectedImages.indexOf(data);
                if(selectedPosition>=0){
                    mask.setVisibility(View.VISIBLE);
                    selectIndex.setVisibility(View.VISIBLE);
                    selectIndex.setText(String.valueOf(selectedPosition+1));
                }else{
            ...
            if(SizeUtils.imageSizeValid(data,mPageTemplate)){
                invalidSize.setVisibility(View.GONE);
            }else {
                invalidSize.setVisibility(View.VISIBLE);
            }
